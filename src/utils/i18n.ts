...
export const UI_TRANSLATIONS = {
  en: {
    ...
    navGodsLaw: "God's Law & Commandments",
    ...
    svgTreeView: "Generational Tree (SVG)",
    sequentialView: "Sequential Order",
    expandAll: "Expand All",
    collapseAll: "Collapse All",
    downloadSvg: "Download SVG",
    panHint: "Drag to pan · Scroll to zoom · Click node to inspect",
    ...
    // God's Law & Divine Commandments
    godsLawTitle: "God's Law & Divine Commandments",
    godsLawSubtitle: "Sacred statutes, covenants, and moral ordinances spoken directly by God to humankind and His prophets.",
    addLaw: "+ Add God's Law",
    editLaw: "Edit Law",
    deleteLaw: "Delete",
    deleteLawModalTitle: "Delete Divine Law",
    confirmDeleteLaw: "Are you sure you want to remove this law from the codex? This action cannot be undone.",
    lawTitleEn: "Title (English)",
    lawTitleAr: "Title (Arabic)",
    spokenTo: "Spoken To (Recipient)",
    spokenToAr: "Spoken To (Arabic)",
    spokenToPlaceholder: "e.g. Moses and the Children of Israel, Noah, Adam...",
    spokenBy: "Spoken By / Setting",
    spokenByAr: "Spoken By / Setting (Arabic)",
    spokenByPlaceholder: "e.g. God out of the fire on Mount Sinai, God in the Garden of Eden...",
    lawCategory: "Category",
    commandmentText: "God's Spoken Words (Scripture)",
    commandmentTextEn: "God's Spoken Words (English)",
    commandmentTextAr: "God's Spoken Words (Arabic)",
    commandmentTextPlaceholder: "Enter the direct words spoken by the Lord...",
    scriptureReference: "Scripture Reference",
    scriptureReferenceAr: "Scripture Reference (Arabic)",
    scripturePlaceholder: "e.g. Exodus 20:1-17; Deuteronomy 5:6-21",
    summaryLabel: "Spiritual Significance & Context",
    summaryEn: "Summary & Meaning (English)",
    summaryAr: "Summary & Meaning (Arabic)",
    lawYearBC: "Historical Date (BC)",
    lawLocation: "Biblical Location",
    lawLocationAr: "Location in Arabic",
    keyPrinciples: "Key Principles & Precepts",
    keyPrinciplesPlaceholder: "e.g. Monotheism, Sanctity of Life, Justice (comma-separated)",
    linkedPeople: "Associated Biblical Figures",
    allCategories: "All Categories",
    catMoral: "Moral & Ten Commandments",
    catCovenant: "Covenants & Pledges",
    catCivil: "Civil & Judicial Ordinances",
    catCeremonial: "Ceremonial & Worship",
    catSabbath: "Sabbaths & Holy Feasts",
    catHoliness: "Holiness & Ethical Code",
    catOther: "Other Decrees",
    filterByRecipient: "Filter by Recipient",
    allRecipients: "All Recipients",
    searchLawsPlaceholder: "Search divine laws, commandments, spoken words, or references...",
    totalLawsCount: "Recorded Divine Laws",
    copyScripture: "Copy Scripture",
    copied: "Copied!",
    viewLawDetails: "View Law Codex",
    noLawsFound: "No divine laws match the selected criteria.",
    clearLawFilters: "Clear all filters",
    lawsWord: "laws",
    tenCommandmentsShort: "Ten Commandments",
    covenantsShort: "Covenants",
    moralEthicsShort: "Moral & Holiness",
    civilCeremonialShort: "Civil & Worship",
    divineProclamation: "Divine Words Spoken by God",
    viewModeGrid: "Codex Cards",
    viewModeList: "Compact List",
    ...
    timelineTabBiblical: "Biblical Events",
    timelineTabAdams: "Adams’ Chart of History",
    adamsTitle: "Adams’ Synchronological Chart of History",
    adamsSubtitle: "Synchronized World History & Biblical Chronology across Empires and Dynasties (Sebastian Adams, 1871)",
    adamsViewStreams: "Synchronized Streams",
    adamsViewMatrix: "Epochs & Comparative Matrix",
    adamsCivilizationFilter: "Civilizations",
    adamsEraFilter: "Epoch / Period",
    adamsSearchPlaceholder: "Search world events, pharaohs, rulers, artifacts, scriptures...",
    adamsBiblicalSynchronism: "Biblical Synchronism",
    adamsArchaeologicalEvidence: "Archaeological Proof & Artifacts",
    adamsSignificance: "Significance",
    adamsMonumental: "Monumental Milestone",
    adamsMajor: "Major Historical Event",
    adamsAllCivilizations: "All Civilizations",
    adamsAllEras: "All Epochs (4004 BC – 33 AD)",
    adamsTotalEvents: "Synchronized Events",
    adamsCivilizationsCount: "World Civilizations",
    adamsYearsSpan: "Historical Span",
    adamsClose: "Close Dossier",
    adamsRelatedEvents: "Contemporaneous Events in This Epoch",
    adamsChartNotice: "Sebastian Adams’ Synchronological Method",
    adamsChartNoticeDesc: "Inspired by Sebastian C. Adams' acclaimed 1871 chromolithograph chart, presenting world history in parallel streams alongside biblical patriarchs, kings, and prophets.",
    rulerOrLeaderLabel: "Ruler / Leader",
    zoomInAdams: "Expand Scale",
    zoomOutAdams: "Condense Scale",
    resetScaleAdams: "Reset Scale",
    adamsFilterByEnteredEvent: "Focus on Entered Event",
    adamsAllEnteredEvents: "All Entered Events",
    adamsUserEnteredBadge: "Your Entered Event",
    adamsConcurrentWorldEvents: "Real Historical Events on This Period & Date",
    adamsGroupByEntered: "Group by Your Entered Events",
    adamsGroupByEras: "Group by Universal Eras",
    adamsYourEventsCount: "Your Entered Events",
    adamsWorldEventsCount: "Synchronized World History",
  },
  ar: {
    ...
    navGodsLaw: "شريعة الله والوصايا",
    ...
    svgTreeView: "مخطط الأجيال الرأسي (SVG)",
    sequentialView: "تسلسل الأجيال التتابعي",
    expandAll: "توسيع الكل",
    collapseAll: "طي الكل",
    downloadSvg: "تحميل بصيغة SVG",
    panHint: "اسحب للتحريك · مرر للتكبير · اضغط على الشخصية للتفاصيل",
    generation: "الجيل",
    sons: "أبناء",
    ...
    // God's Law & Divine Commandments
    godsLawTitle: "شريعة الله والوصايا الإلهية",
    godsLawSubtitle: "الوصايا والعهود والأحكام المقدسة التي نطق بها الله مباشرة للناس ولأنبيائه في العهد القديم.",
    addLaw: "+ إضافة شريعة إلهية",
    editLaw: "تعديل الشريعة",
    deleteLaw: "حذف",
    deleteLawModalTitle: "حذف الشريعة الإلهية",
    confirmDeleteLaw: "هل أنت متأكد من رغبتك في حذف هذه الشريعة من المدونة؟ لا يمكن التراجع عن هذا الإجراء.",
    lawTitleEn: "العنوان (باللغة الإنجليزية)",
    lawTitleAr: "العنوان (باللغة العربية)",
    spokenTo: "المُخاطَب بها (المُتلقي)",
    spokenToAr: "المُخاطَب بها (بالعربية)",
    spokenToPlaceholder: "مثال: موسى وبنو إسرائيل، نوح، آدم، إبراهيم...",
    spokenBy: "المُتكلِم / سياق الخطاب الإلهي",
    spokenByAr: "المُتكلِم / سياق الخطاب الإلهي (بالعربية)",
    spokenByPlaceholder: "مثال: الله من وسط النار على جبل سيناء، الرب في جنة عدن...",
    lawCategory: "تصنيف الشريعة",
    commandmentText: "نص كلام الله المقدس (الشاهد)",
    commandmentTextEn: "كلام الله المنطوق (بالإنجليزية)",
    commandmentTextAr: "كلام الله المنطوق (بالعربية)",
    commandmentTextPlaceholder: "اكتب الكلمات الصريحة التي نطق بها الرب...",
    scriptureReference: "الشاهد الكتابي",
    scriptureReferenceAr: "الشاهد الكتابي (بالعربية)",
    scripturePlaceholder: "مثال: خروج 20: 1-17؛ تثنية 5: 6-21",
    summaryLabel: "المعنى الروحي والسياق اللاهوتي",
    summaryEn: "المعنى والسياق (بالإنجليزية)",
    summaryAr: "المعنى والسياق (بالعربية)",
    lawYearBC: "التاريخ التقريبي (ق.م)",
    lawLocation: "الموقع الكتابي",
    lawLocationAr: "الموقع (بالعربية)",
    keyPrinciples: "المبادئ والفضائل الجوهرية",
    keyPrinciplesPlaceholder: "مثال: التوحيد، قدسية الحياة، العدالة (افصل بفواصل)",
    linkedPeople: "الشخصيات الكتابية المرتبطة",
    allCategories: "جميع التصنيفات",
    catMoral: "الوصايا العشر والأخلاق",
    catCovenant: "العهود والمواثيق الإلهية",
    catCivil: "الأحكام المدنية والقضائية",
    catCeremonial: "الطقوس والعبادة والكهنوت",
    catSabbath: "السبوت والأعياد المقدسة",
    catHoliness: "القداسة والسلوك الفاضل",
    catOther: "أوامر ونواهٍ أخرى",
    filterByRecipient: "تصفية حسب المُخاطَب",
    allRecipients: "كافة المُخاطَبين",
    searchLawsPlaceholder: "ابحث في شرائع الله، الوصايا، الكلمات الإلهية، أو الشواهد...",
    totalLawsCount: "الشرائع الإلهية المسجلة",
    copyScripture: "نسخ النص",
    copied: "تم النسخ بنجاح!",
    viewLawDetails: "عرض تفاصيل الشريعة",
    noLawsFound: "لا توجد شرائع مطابقة لبحثك أو التصفيات الحالية.",
    clearLawFilters: "إلغاء كافة التصفيات",
    lawsWord: "شرائع",
    tenCommandmentsShort: "الوصايا العشر",
    covenantsShort: "العهود",
    moralEthicsShort: "القداسة والأخلاق",
    civilCeremonialShort: "القضاء والطقوس",
    divineProclamation: "كلمات النطق الإلهي",
    viewModeGrid: "بطاقات المدونة",
    viewModeList: "قائمة موجزة",
    ...
    // Adams' Chart of History
    timelineTabBiblical: "أحداث العهد القديم",
    timelineTabAdams: "لوحة آدامز التاريخية المتزامنة",
    adamsTitle: "لوحة سيباستيان آدامز التاريخية المتزامنة",
    adamsSubtitle: "التاريخ العالمي المتزامن مع الكتاب المقدس والحضارات القديمة عبر العصور (سيباستيان آدامز، ١٨٧١)",
    adamsViewStreams: "المسارات المتزامنة",
    adamsViewMatrix: "العصور والمقارنات التاريخية",
    adamsCivilizationFilter: "الحضارات",
    adamsEraFilter: "الحقبة الزمنية",
    adamsSearchPlaceholder: "ابحث في الأحداث العالمية، الفراعنة، الملوك، الآثار، الشواهد...",
    adamsBiblicalSynchronism: "التزامن مع الكتاب المقدس",
    adamsArchaeologicalEvidence: "الأدلة والآثار المكتشفة",
    adamsSignificance: "الأهمية التاريخية",
    adamsMonumental: "محطة تاريخية عظمى",
    adamsMajor: "حدث تاريخي بارز",
    adamsAllCivilizations: "كافة الحضارات",
    adamsAllEras: "كافة العصور (٤٠٠٤ ق.م – ٣٣ م)",
    adamsTotalEvents: "حدثاً تاريخياً متزامناً",
    adamsCivilizationsCount: "حضارات عالمية",
    adamsYearsSpan: "المدى الزمني",
    adamsClose: "إغلاق التفاصيل",
    adamsRelatedEvents: "أحداث متزامنة في نفس الحقبة",
    adamsChartNotice: "طريقة سيباستيان آدامز للتزامن التاريخي",
    adamsChartNoticeDesc: "مستوحاة من لوحة سيباستيان آدامز الكروموليثوغرافية الشهيرة لعام ١٨٧١، لتقديم التاريخ العالمي في مسارات متوازية متزامنة جنباً إلى جنب مع آباء وأنبياء وملوك الكتاب المقدس.",
    rulerOrLeaderLabel: "الحاكم / القائد",
    zoomInAdams: "توسيع المقياس",
    zoomOutAdams: "تقليص المقياس",
    resetScaleAdams: "إعادة ضبط المقياس",
    adamsFilterByEnteredEvent: "التركيز على حدث أدخلتَه",
    adamsAllEnteredEvents: "كافة الأحداث المُدخلة",
    adamsUserEnteredBadge: "حدث من بياناتك",
    adamsConcurrentWorldEvents: "الأحداث التاريخية الحقيقية في نفس الفترة والتاريخ",
    adamsGroupByEntered: "ترتيب حسب أحداثك المُدخلة",
    adamsGroupByEras: "ترتيب حسب العصور الكبرى",
    adamsYourEventsCount: "الأحداث التي أدخلتها",
    adamsWorldEventsCount: "أحداث التاريخ العالمي المتزامنة",
  },
};
