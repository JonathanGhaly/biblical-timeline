...
export default function EditPersonModal({
  ...
  const availablePeople = personList.filter((p) => p.id !== person.id);
  const males = availablePeople.filter((p) => p.gender === "male");
  const females = availablePeople.filter((p) => p.gender === "female");
